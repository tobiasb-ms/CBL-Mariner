...
# cd rdoc && git archive -v -o rdoc-6.3.2-tests.tar.gz v6.3.2 test/
...
# Fix compatibility with recent RubyGems.
# https://github.com/ruby/rdoc/pull/810.patch
Patch1: rubygem-rdoc-6.3.2-Use-test-unit-assertions-instead-of-minitest.patch
...
# The explicit require of WEBrick could be eventually removed:
# https://github.com/ruby/rdoc/pull/833
RUBYOPT=-Ilib \
  ruby -rwebrick -e 'Dir.glob "./test/**/test_*.rb", &method(:require)' -- -v
popd
